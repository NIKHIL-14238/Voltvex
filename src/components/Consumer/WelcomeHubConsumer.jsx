...
function WelcomeHubConsumer() {
  const navigate = useNavigate();

  const goToDashboard = () => {
    navigate("/consumer/dashboard"); // Adjust based on role if needed
  };

  const goToEnergyHub = () => {
    navigate("/consumer/energyhub"); // Adjust based on role if needed
  };
    ...
    <div className="text-white">
      ...
      <section className="bg-gradient-to-b from-[#272727] to-[#020202] pt-30 pb-10 text-center justify-center items-center flex flex-col">
        <div className="text-6xl font-bold poppins mb-5 text-[#9D85BE]">
          Welcome <span className="font-mono"> Consumer</span>
        </div>
...
export default WelcomeHubConsumer;
